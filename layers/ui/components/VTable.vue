  ...
  <div class="overflow-x-auto hide-scrollbar" :class="wrapperClass">
    <table class="w-full text-start" :class="tableClass">
      <thead v-if="headers && headers.length"
        class="text-[9px] font-black text-gray-600 tracking-widest border-b border-white/5 bg-black/40">
        <tr>
      ...
      <tbody class="divide-y divide-white/[0.03]">
        <tr v-for="(item, index) in items" :key="item.id || index" class="group hover:bg-white/[0.02] transition-colors"
