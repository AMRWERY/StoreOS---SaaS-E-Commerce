  ...
  <div :class="section.is_hidden ? 'hidden' : ''">
      ...
      <div
        ...
        style="
          background-image: linear-gradient(
            ...
            url('https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=1400&q=80');
        "
      >
      ...
      <div
        ...
        style="
          background-image: linear-gradient(
            ...
            url('https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=1400&q=80');
        "
      >
    ...
    <template v-else-if="section.type === 'product_featured'">
      <div class="grid min-h-[400px] grid-cols-2">
        <div
          ...
          style="
            background-image: url('https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=800&q=80');
          "
        />
    ...
    <template v-else-if="section.type === 'categories_grid'">
      <div class="px-8 py-12">
        ...
        <div
          v-if="str('card_style', 'overlay') === 'below'"
    ...
    <template v-else-if="section.type === 'image_text'">
      <div class="grid min-h-[280px] grid-cols-2">
        <div
          class="bg-cover bg-center bg-neutral-200"
          style="
            background-image: url('https://images.unsplash.com/photo-1513519245088-0e12902e35ca?w=800&q=80');
          "
        />
        <div class="flex flex-col justify-center px-10 py-12">
          ...
          <p class="mt-4 text-[15px] leading-relaxed text-neutral-600">
            {{
              str(
                "body",
                "Tell your brand story, highlight what makes you special."
              )
            }}
          </p>
        </div>
