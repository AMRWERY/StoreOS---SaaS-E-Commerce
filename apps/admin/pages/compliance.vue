        ...
        <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
          <div class="space-y-6">
            <div class="flex items-center gap-4">
              <div class="w-14 h-14 rounded-2xl bg-brand/10 border border-brand/20 flex items-center justify-center">
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-20 space-y-24">
      ...
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        <div class="lg:col-span-4 min-w-0 space-y-6">
          ...
          <div class="pt-6">
            <LazyVButton to="/whitepaper" label="Full Whitepaper" icon="solar:shield-warning-bold" variant="primary"
        ...
        <div class="lg:col-span-8 min-w-0 bg-bg-primary border border-border-subtle rounded-3xl overflow-hidden">
          ...
          <LazyVTable :headers="tableHeaders" :items="tableItems" table-class="!bg-transparent">
      ...
      <section
        ...
        <LazyVButton to="/privacy" label="View Privacy Protocol" icon="solar:arrow-right-linear" variant="secondary"
...
const tableHeaders = [
  {
    ...
    key: "sector",
    class: "text-[12px] font-bold text-tx-primary",
  },
...
const tableItems = [
  {
    sector: "Network Layer Architecture",
    status: "Encrypted",
    protocol: "TLS 1.3 / AES-256",
  },
  {
    sector: "IAM Identity Management",
    status: "Active",
    protocol: "OAuth 2.1 / SAML",
  },
  {
    sector: "Database Persistence",
    status: "Isolated",
    protocol: "Point-in-Time Recovery",
  },
  {
    sector: "Asset Delivery (CDN)",
    status: "Global",
    protocol: "Edge SSL Termination",
  },
];
...
const securityProtocols = [
  ...
  {
    id: "SC-102",
    protocol: "DDoS Mitigation",
    value: "Edge Layer 7",
    status: "OPTIMAL",
  },
  {
    id: "SC-103",
    protocol: "Identity Access",
    value: "Multi-Factor Auth",
    status: "ENFORCED",
  },
  {
    id: "SC-104",
    protocol: "Data Residency",
    value: "Regional Isolated",
    status: "COMPLIANT",
  },
];
