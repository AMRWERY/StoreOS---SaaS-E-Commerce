<template>
  <div>
    <div class="min-h-screen bg-bg-base text-tx-primary selection:bg-brand/30 p-6 lg:p-12">
      <!-- --- BREADCRUMBS --- -->
      <LazyVBreadcrumb :items="breadcrumbItems" class="mb-10" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 max-w-7xl mx-auto">
        ...
        <div class="lg:col-span-6 space-y-10">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3">
              <div v-for="color in colors" :key="color.name" @click="selectedColor = color.name"
                class="w-8 h-8 rounded-full cursor-pointer p-0.5 border-border-default transition-all" :class="[
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-2">
              <button v-for="size in ['38mm', '42mm']" :key="size" @click="selectedSize = size"
                class="px-6 py-2 rounded-[8px] border text-[12px] font-bold transition-all" :class="[
                  selectedSize === size
          ...
          <div class="flex gap-4 pt-4">
            ...
            <LazyVButton to="/checkout" variant="none"
          ...
          <div class="flex items-center gap-2 pt-4">
            ...
            <span class="text-[11px] font-bold text-[#10B981] tracking-widest">{{ t("storefront.product.inStock")
            }}</span>
          </div>

          <!-- Accordion -->
          <LazyVAccordion :items="productSections" class="pt-6 border-t border-border-subtle">
