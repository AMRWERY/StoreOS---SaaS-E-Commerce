...
export const EDITORIAL_ARTICLES: EditorialArticle[] = [
  ...
  },
  {
    ...
    excerpt:
      "A guide to the visual documentation process of the StoreOS product catalog.",
    author: "CHEN_D",
    date: "2024.02.14",
    readTime: "06:30",
    image: "/img/collection-04.png",
  },
];

export function getEditorialArticleById(
  id: string,
