  ...
  >
    <div class="flex items-center gap-3">
      ...
      <h3 class="text-sm font-bold">
        {{ t("dashboard.profile.preferences") }}
      </h3>
    </div>
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-3 pt-4 border-t border-border-subtle">
        ...
        <div
          class="flex items-center justify-between p-4 bg-bg-primary rounded-xl border border-border-subtle"
        >
          <div
            class="flex items-center gap-3 text-xs font-bold text-tx-secondary"
          >
            <Icon :name="isDark ? 'ph:moon-stars-fill' : 'ph:sun-bold'" />
            {{
              isDark
          ...
          <button
            ...
            :aria-checked="!isDark"
            :aria-label="
              isDark ? t('nav.useLightTheme') : t('nav.useDarkTheme')
            "
            @click="toggleTheme"
          >
            <span
