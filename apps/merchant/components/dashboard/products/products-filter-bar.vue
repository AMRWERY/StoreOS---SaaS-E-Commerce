          ...
          <template #default="{ close }">
            <div class="flex flex-col gap-1">
              <LazyVButton
                ...
                :className="`text-start px-3 py-2 rounded-lg text-sm font-medium transition-all ${
          ...
          <template #default="{ close }">
            <div class="flex flex-col gap-1">
              <LazyVButton
                ...
                :className="`text-start px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${
