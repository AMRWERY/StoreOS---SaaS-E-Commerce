    ...
    >
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-[9px] font-black text-tx-muted tracking-widest mt-1">
            {{ subtitle }}
          </p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        >
          <span
            :class="[
              ...
              channel.unavailable
                ? 'opacity-40 italic text-tx-muted'
          ...
          <span
            v-if="channel.unavailable"
            class="text-[8px] font-black text-tx-muted border border-border-default px-1.5 py-0.5 rounded"
            >UNAVAILABLE</span
          >

          <LazyVSwitchButton
            v-else
            :modelValue="modelValue[channel.key]"
            @update:modelValue="
              (val: boolean) =>
        ...
        <!-- Extra Slot for merchanthook rows etc -->
        <slot />
      </div>
    </section>
  </div>
