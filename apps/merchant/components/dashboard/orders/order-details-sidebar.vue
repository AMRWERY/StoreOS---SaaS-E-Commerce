    ...
    <div class="fixed inset-0 z-50 overflow-hidden" @click.self="$emit('close')">
      ...
      <aside
        ...
        <div class="px-4 py-3.5 flex-1 overflow-y-auto hide-scrollbar">
          ...
          <!-- Customer Info -->
          <div class="mb-6">
            <h3 class="text-[10px] font-black text-tx-muted tracking-[0.2em] mb-6">
          ...
          <div>
            <div class="flex justify-between items-center mb-6">
              ...
              <LazyVButton variant="none" className="text-[10px] font-bold text-brand hover:underline" @click="
                navigateTo({
