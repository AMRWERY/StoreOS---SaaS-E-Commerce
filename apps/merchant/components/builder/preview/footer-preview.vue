<template>
  ...
  >
      ...
      >
        ...
        >
          ...
          <div class="mt-4 flex gap-2">
            <div
              class="flex-1 rounded-xl border border-neutral-600 bg-neutral-700/50 px-3 py-2.5 text-xs text-neutral-400"
            >
              your@email.com
            </div>
            <button
          ...
          <div
            v-if="store.footerShowSocial"
            class="mt-4 flex gap-3 text-neutral-500"
          >
    ...
    <!-- ── Style: minimal ─────────────────────────────────────────── -->
    <div
      v-else-if="store.footerStyle === 'minimal'"
      class="border-t border-neutral-200 bg-white px-8 py-5"
    >
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-4">
          <div
            v-if="store.footerShowSocial"
            class="flex gap-2.5 text-neutral-400"
          >
            <Icon name="ph:instagram-logo-bold" />
            <Icon name="ph:twitter-logo-bold" />
          </div>
