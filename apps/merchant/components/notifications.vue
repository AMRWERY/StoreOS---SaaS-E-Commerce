      ...
      <Transition name="slide">
        ...
        >
          ...
          <div class="flex-1 overflow-y-auto hide-scrollbar bg-bg-primary/5">
              ...
              >
                <div class="flex gap-5">
                  ...
                  <div class="relative shrink-0">
                    <div
                      :class="[
                        'w-14 h-14 rounded-2xl flex items-center justify-center border border-border-subtle shadow-inner',
                        n.bgColor,
                      ]"
                    >
                      <ClientOnly>
                        <Icon
                          :name="n.icon"
                          :class="['text-2xl', n.iconColor]"
                        />
                      </ClientOnly>
                    </div>
                    <span
                      v-if="!n.read"
                      class="absolute -top-1 -end-1 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-bg-primary animate-ping"
                    ></span>
                  </div>
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p
                      class="text-xs text-tx-secondary mt-2 line-clamp-2 leading-relaxed font-medium"
                    >
                      {{ n.message }}
                    </p>
            ...
            <div
              v-else
              class="h-full flex flex-col items-center justify-center text-center p-5"
            >
              <div
              ...
              <p
                class="text-sm text-tx-muted mt-3 max-w-[260px] leading-relaxed"
              >
                Notifications about your store activity and security will appear
                here.
              </p>
            </div>
          </div>
