  ...
  <div>
    <div class="flex items-center justify-center p-6 text-tx-primary">
      ...
      >
        ...
        <div
          class="bg-bg-base flex items-center justify-center p-6 text-tx-primary"
        >
          <div class="w-full max-w-2xl">
            ...
            <div class="text-center mb-10">
              ...
              <p class="text-tx-secondary text-sm">
                Choose the payment methods you'd like to offer at checkout.
              </p>
            </div>
            ...
            <div class="space-y-4 mb-12">
              ...
              <div
                class="p-5 rounded-xl border-2 transition-all flex items-center gap-4 cursor-pointer"
                :class="
                  codEnabled
                    ? 'bg-bg-elevated border-brand/50'
                    : 'bg-bg-primary border-border-subtle opacity-60'
                "
                @click="codEnabled = !codEnabled"
              >
                <div
                  class="w-12 h-12 rounded-xl bg-brand-dim flex items-center justify-center shrink-0"
                >
                ...
                <div class="flex-1">
                  ...
                  <p class="text-xs text-tx-secondary">
                    Collect physical payment upon delivery
                  </p>
                </div>
                <!-- Custom Toggle Switch -->
                <div
                  class="w-12 h-6 rounded-full p-1 transition-colors duration-200 relative"
                  :class="
                    codEnabled
                      ? 'bg-brand'
                ...
                >
                  <div
                    ...
                    :class="codEnabled ? 'translate-x-6' : 'translate-x-0'"
                  ></div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <Icon
                    ...
                    class="text-tx-secondary text-2xl"
                  />
                </div>
                <div class="flex-1">
              ...
              <div
                class="p-5 rounded-xl bg-bg-primary border border-border-subtle space-y-6"
              >
                <div class="flex items-center gap-4">
                  <div
                    class="w-12 h-12 rounded-xl bg-red-500/10 flex items-center justify-center shrink-0"
                  >
                    <Icon
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        class="bg-bg-elevated text-[9px] font-black px-2 py-0.5 rounded text-tx-secondary tracking-wider"
                        >Manual</span
                      >
                    </div>
                    <p class="text-xs text-tx-secondary">
                      Manual mobile wallet transfers
                    </p>
                  </div>
                </div>
            ...
            <div class="flex items-center justify-between">
              <LazyVButton
                variant="ghost"
                className="group border-none !px-0 !py-0 hover:!bg-transparent"
                @click="$emit('prev')"
              >
                <Icon
