<template>
  <div class="px-8 py-12">
    <h3
      v-if="bool('show_title', true)"
      class="mb-6 text-lg font-bold text-neutral-900"
    >
    ...
    <div v-else-if="cardStyle === 'pill'" class="flex flex-wrap gap-3">
      <LazyVButton
        ...
        :key="i"
        variant="none"
        className="flex items-center gap-2 rounded-full border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm font-semibold text-neutral-900 shadow-sm"
      >
        <span
