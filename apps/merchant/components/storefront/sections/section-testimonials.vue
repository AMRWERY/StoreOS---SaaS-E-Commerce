...
const FALLBACK_ITEMS = [
  {
    text: "Great product, highly recommended to everyone who values quality!",
    name: "Happy Customer 1",
  },
  {
    text: "Fast shipping and exactly as described. Will definitely order again.",
    name: "Happy Customer 2",
  },
  {
    text: "Exceeded my expectations. The quality is outstanding for the price.",
