<template>
  <div class="border-t border-neutral-200 px-8 py-12">
    ...
    <div v-if="bool('show_view_all', true)" class="mt-8 text-center">
      <LazyVButton
        variant="none"
        className="rounded-md border border-neutral-300 px-6 py-2 text-sm font-semibold text-neutral-700 hover:bg-neutral-50"
      >
