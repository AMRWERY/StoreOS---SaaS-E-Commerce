<template>
  <div
    class="flex min-h-[200px] items-center justify-center px-8 py-12 text-center"
    :style="
      str('image_url')
        ? {
            backgroundImage: `linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('${str('image_url')}')`,
