<template>
  <div>
    <div class="min-h-screen text-tx-primary pb-24">
      <LazyVBreadcrumb class="mb-6" :overrides="{ [String($route.params.id)]: customer.name }" />
            ...
            <div v-if="activeTab === tabs[0]">
              ...
              <div class="space-y-3">
                <div v-for="order in orders" :key="order.id"
                  ...
                  <span class="text-xs font-bold text-tx-secondary group-hover/row:text-brand transition-colors">{{
                    order.id }}</span>
                  ...
                  <div class="text-end">
                    <p class="text-[9px] font-semibold text-tx-muted tracking-[0.6px]">
                      $
                    </p>
              ...
              <div v-for="activity in activities" :key="activity.id"
                ...
                <div>
                  <p class="text-sm font-medium">
                    ...
                    <span v-if="activity.target" class="text-brand font-bold capitalize">{{ activity.target }}</span>
                  </p>
                  <p class="text-[10px] text-tx-muted mt-1 font-semibold tracking-[0.6px]">
                    {{ activity.date }}
                  </p>
                </div>
              </div>
        ...
        <aside class="lg:col-span-4 space-y-6">
          ...
          <section class="bg-bg-primary border border-border-subtle rounded-2xl p-6 shadow-xl shadow-black/20">
            ...
            <div v-else class="space-y-6">
              ...
              <div class="flex gap-2 pt-2">
                <LazyVButton variant="primary" size="sm" :label="t('common.save')" className="flex-1"
                  @click="saveContact" />
                <LazyVButton variant="secondary" size="sm" :label="t('common.cancel')"
          ...
          <section class="bg-bg-primary border border-brand/20 rounded-2xl p-6 group overflow-hidden relative">
            <div class="flex items-center gap-5">
              ...
              <div>
                <h3 class="text-[10px] font-semibold text-tx-secondary tracking-[0.6px] mb-1">
      ...
      <div
        ...
        <div class="flex items-center gap-2">
          <div class="group relative">
            <LazyVButton variant="none" :to="`mailto:${customer.email}`"
          ...
          <div class="group relative">
            <LazyVButton variant="none" className="p-3 text-tx-secondary hover:text-tx-primary transition-colors">
          ...
          <div class="group relative">
            <LazyVButton variant="none" :to="`tel:${customer.phone}`"
              className="p-3 text-tx-secondary hover:text-tx-primary transition-colors">
