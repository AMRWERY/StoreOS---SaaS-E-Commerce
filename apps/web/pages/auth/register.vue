          ...
          <div class="max-w-md mx-auto">
            ...
            <VFormWrapper @submit="handleSubmit">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <VInput :label="t('auth.register.storeName')" :placeholder="t('auth.register.storeNamePlaceholder')"
                  v-model="storeName" />
                <VInput :label="t('auth.register.fullName')" :placeholder="t('auth.register.fullNamePlaceholder')"
                  v-model="fullName" />
              </div>

              <VInput type="email" :label="t('auth.register.emailAddress')"
                :placeholder="t('auth.register.emailPlaceholder')" v-model="email" />

              <VInput type="password" :label="t('auth.register.password')"
...
useSeoMeta({
  ...
  description:
    "Create your StoreOS merchant account and start managing your store today.",
