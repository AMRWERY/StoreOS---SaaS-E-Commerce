<template>
  <div>
    <div class="min-h-screen text-tx-primary pb-24">
      <VBreadcrumb
        class="mb-6"
        :overrides="{ [String($route.params.id)]: customer.name }"
      />
      ...
      >
        <div class="flex items-center gap-6">
          ...
          <div>
            ...
            <div class="flex flex-wrap items-center gap-x-6 gap-y-2 mt-2">
              <div
                class="flex items-center gap-2 text-xs text-tx-secondary font-medium"
              >
            ...
            <p
              class="text-[10px] font-semibold text-tx-muted tracking-[0.6px] mt-3"
            >
        ...
        <div class="flex items-center gap-3">
          <VButton
            variant="primary"
            :label="t('dashboard.customers.newOrder')"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 mb-6">
        ...
        >
          ...
          <div class="flex items-baseline gap-2">
            <span
              v-if="stat.prefix"
              class="text-xl font-bold text-tx-secondary"
              >{{ stat.prefix }}</span
            >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-3">
        ...
        <div
          class="lg:col-span-8 bg-bg-primary border border-border-subtle rounded-2xl overflow-hidden flex flex-col"
        >
          <!-- Tabs Header -->
          <div class="px-6 pt-6 border-b border-border-subtle flex gap-8">
            ...
            >
              ...
              <div
                v-if="activeTab === tab"
                class="absolute bottom-0 start-0 w-full h-0.5 bg-brand"
              ></div>
            </button>
          </div>
          ...
          <div class="px-4 py-3.5 flex-1">
                ...
                >
                  ...
                  <div class="flex justify-center">
                    <span
                      :class="[
                        order.color,
                        'text-[9px] font-black px-3 py-1 rounded-md tracking-widest',
                      ]"
                    >
                      {{ order.status }}
                    </span>
                  ...
                  <span
                    class="text-xs font-medium text-tx-secondary text-center"
                    >{{ order.date }}</span
                  >
                  <div class="text-end">
                    <p
                      class="text-[9px] font-semibold text-tx-muted tracking-[0.6px]"
                    >
                      $
                    </p>
            ...
            <div v-if="activeTab === tabs[1]" class="space-y-6">
              <!-- Add Note -->
              <div
                class="bg-bg-overlay rounded-2xl p-6 border border-border-subtle"
              >
                <textarea
                  v-model="newNote"
                ...
                <div class="flex justify-end mt-4">
                  <VButton
                    variant="primary"
                    size="sm"
                    :label="t('dashboard.customers.addNote')"
                    @click="handleAddNote"
                  ...
                  >
                    <div class="flex items-center justify-between mb-3">
                      <span
                        ...
                        >{{ note.author }} • {{ note.date }}</span
                      >
                      <button
                        class="text-tx-muted hover:text-danger transition-colors"
                      >
                ...
                <div>
                  <p class="text-sm font-medium">
                    ...
                    <span
                      ...
                      class="text-brand font-bold capitalize"
                      >{{ activity.target }}</span
                    >
                  </p>
                  <p
                    class="text-[10px] text-tx-muted mt-1 font-semibold tracking-[0.6px]"
                  >
                    {{ activity.date }}
                  </p>
                </div>
        ...
        <aside class="lg:col-span-4 space-y-6">
          <!-- Contact Metadata -->
          <section
            class="bg-bg-primary border border-border-subtle rounded-2xl p-6 shadow-xl shadow-black/20"
          >
          ...
          <section
            class="bg-bg-primary border border-border-subtle rounded-2xl p-6 overflow-hidden"
          >
            <div class="flex justify-between items-center mb-6">
              <h3
                class="text-[10px] font-semibold text-tx-muted tracking-[0.6px]"
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p class="text-[10px] text-tx-secondary mt-1 leading-relaxed">
                    {{ address.value }}
                  </p>
                </div>
              </div>
          ...
          <!-- Risk Analysis -->
          <section
            class="bg-bg-primary border border-brand/20 rounded-2xl p-6 group overflow-hidden relative"
          >
            <div class="flex items-center gap-5">
              <div
                class="w-12 h-12 rounded-xl bg-success-dim flex items-center justify-center shrink-0"
              >
                <Icon
              ...
              <div>
                <h3
                  class="text-[10px] font-semibold text-tx-secondary tracking-[0.6px] mb-1"
                >
                  {{ t("dashboard.customers.riskAnalysis") }}
                </h3>
                <div class="flex items-center gap-2">
                  ...
                  ></div>
                  <span
                    class="text-[10px] font-black text-success tracking-widest"
                    >Low_Risk_Score: {{ customer.riskScore }}</span
                  >
                </div>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          <span
            class="ms-2 px-1.5 py-0.5 bg-bg-elevated border border-border-default rounded text-[8px] text-tx-secondary"
            >⌘K</span
          >
        </div>
        <div class="flex items-center gap-2">
          <div class="group relative">
            ...
            <span
              class="absolute -top-10 start-1/2 -translate-x-1/2 px-2 py-1 bg-bg-primary text-[8px] font-black text-tx-secondary rounded border border-border-default opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none tracking-widest"
              >Email [E]</span
            >
          </div>
