<template>
  <div>
    <div class="min-h-screen text-[#e1e1e1] -mt-4">
        ...
        <div>
          <div class="flex items-center gap-4">
            ...
            <div class="flex gap-2">
              ...
              <span
                class="rounded-full px-2 py-0.5 text-[10px] font-semibold bg-success-dim text-success">PAID</span>
            </div>
          </div>
          <p class="text-xs text-tx-secondary mt-2 font-medium">Created on {{ createdAt }}</p>
        </div>
      ...
      <section class="bg-bg-primary border border-border-subtle rounded-2xl px-4 py-3.5 mb-6 relative overflow-hidden">
        <div class="flex justify-between items-start relative z-10">
          <div v-for="(step, i) in timeline" :key="step.name" class="flex flex-col items-center flex-1 relative">
            ...
            <div v-if="i < timeline.length - 1" class="absolute top-5 start-[50%] w-full h-[2px] -z-10"
              :class="step.status === 'completed' ? 'bg-brand' : 'bg-bg-elevated'"></div>

            <!-- Step Icon -->
            <div class="w-10 h-10 rounded-full flex items-center justify-center mb-4 transition-all" :class="[
              step.status === 'completed' ? 'bg-brand text-white' :
                step.status === 'active' ? 'bg-brand-dim text-brand ring-2 ring-brand/30' :
          ...
          <div class="h-full space-y-6 overflow-y-auto hide-scrollbar pb-10">
            ...
            <div class="bg-bg-primary border border-border-subtle rounded-2xl overflow-hidden">
              ...
              <div class="px-4 py-3.5">
                ...
                <!-- Summary -->
                <div class="mt-6 pt-6 border-t border-border-subtle flex flex-col items-end space-y-4">
            ...
            <div class="bg-bg-primary border border-border-subtle rounded-2xl px-4 py-3.5">
              <h3 class="text-xs font-black tracking-[0.15em] flex items-center gap-2 mb-6">
              ...
              <div class="space-y-6">
                ...
                <div class="space-y-6 pt-4">
                  <div v-for="log in orderLogs" :key="log.time" class="flex gap-4 group">
                    ...
                    <div>
                      <p class="text-xs leading-relaxed text-tx-secondary">{{ log.text }}</p>
                      <div class="mt-2 text-[10px] font-bold">
                        <span class="text-brand">added by {{ log.author }}</span>
          ...
          <div class="bg-bg-primary border border-border-subtle rounded-2xl p-6">
            ...
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p class="text-[10px] text-tx-muted mt-0.5">+1 (555) 012-9842</p>
              </div>
            </div>
