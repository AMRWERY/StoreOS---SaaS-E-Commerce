<template>
  <div>
    <div class="min-h-screen text-[#e1e1e1] -mt-5">
      ...
      <!-- Footer -->
      <div class="mt-8">
        <VPagination :total="filteredProducts.length" :perPage="perPage" v-model:currentPage="currentPage" />
      </div>
    </div>
  </div>
</template>
...
const { activeFilter, viewMode, currentPage, perPage, filters, products, filteredProducts, paginatedProducts } = storeToRefs(productsStore)
