  ...
  <div class="min-h-screen bg-bg-base flex flex-col items-center justify-center p-6 text-tx-primary">
    ...
    <div class="w-full max-w-[560px] bg-bg-primary border border-border-subtle rounded-2xl p-5 shadow-2xl">
      ...
      <div class="mb-10">
        ...
        <p class="text-tx-secondary text-sm">Tell us a bit about your business to get started.</p>
      </div>
      ...
      <VFormWrapper @submit="handleContinue" class="space-y-7">
        ...
        <!-- Store Logo Upload -->
        <VFileUpload label="Store logo" icon="ph:cloud-arrow-up-fill" iconClass="text-brand text-3xl"
          ...
          <p class="text-sm font-medium mb-1">
            Drag and drop or <span class="text-brand hover:underline">browse</span>
          </p>
          <p class="text-[11px] text-tx-muted font-bold tracking-tight">PNG, JPG or SVG (Max. 2MB)</p>
        </VFileUpload>

        <!-- Store Description -->
        <div class="space-y-2.5">
          <label class="text-[11px] font-bold text-tx-secondary tracking-wider">Store description</label>
          <textarea v-model="description" rows="4" placeholder="Describe what you sell..."
            class="w-full bg-bg-elevated border border-border-default rounded-md px-3 py-2 text-[12px] text-tx-primary focus:outline-none focus:border-brand transition-colors resize-none placeholder:text-tx-muted"></textarea>
        </div>

        <!-- Country & Currency -->
        <div class="grid grid-cols-2 gap-4">
          <div class="space-y-2.5">
            <label class="text-[11px] font-bold text-tx-secondary tracking-wider">Country</label>
            <div class="relative">
          ...
          <div class="space-y-2.5">
            <label class="text-[11px] font-bold text-tx-secondary tracking-wider">Currency</label>
            <div class="relative">
