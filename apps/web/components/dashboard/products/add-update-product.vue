<template>
  <div>
    <div class="min-h-screen text-tx-primary -mt-5">
      ...
      <div class="max-w-[1400px] mx-auto px-4 py-3.5 lg:px-4 lg:py-3.5 grid grid-cols-1 lg:grid-cols-12 gap-8 -mt-5">
              ...
              <div class="space-y-3">
                ...
                <div class="bg-black border border-border-default rounded-xl p-3 flex flex-wrap gap-2">
                  <span v-for="tag in product.tags" :key="tag"
                    ...
                    {{ tag }}
                    <Icon name="ph:x-bold" class="cursor-pointer hover:text-tx-primary" />
                  </span>
