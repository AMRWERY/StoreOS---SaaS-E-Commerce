  ...
  <div>
    <section class="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-border-subtle pt-16">
      <div class="lg:col-span-4">
        <h3 class="font-bold text-lg mb-2">Localization</h3>
        <p class="text-xs text-tx-secondary leading-relaxed">Regional settings that affect checkout, tax calculations, and
          delivery times.</p>
      </div>
      <div class="lg:col-span-8 space-y-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="space-y-2">
            <label class="text-[10px] font-bold text-tx-secondary tracking-wider">Currency</label>
            <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="space-y-3">
            <label class="text-[10px] font-bold text-tx-secondary tracking-wider">Unit System</label>
          ...
          <div class="space-y-2">
            <label class="text-[10px] font-bold text-tx-secondary tracking-wider">Default Language</label>
            <div class="relative">
