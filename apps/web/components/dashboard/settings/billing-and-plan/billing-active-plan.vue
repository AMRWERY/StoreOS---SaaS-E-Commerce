  ...
  <div>
    <section class="bg-bg-primary border border-border-subtle rounded-2xl px-4 py-3.5 relative overflow-hidden">
      <div class="flex flex-col md:flex-row justify-between gap-8 mb-6">
        <div>
          <p class="text-[10px] font-black text-tx-muted tracking-widest mb-4">Active Plan</p>
          ...
          <div class="flex gap-10 mt-6">
            <div>
              <p class="text-[9px] font-black text-tx-muted tracking-widest mb-1">Billing Cycle</p>
        ...
        <div
          ...
          <p class="text-[9px] font-black text-tx-muted tracking-widest mb-2">Current Monthly Total</p>
