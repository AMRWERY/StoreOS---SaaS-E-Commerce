            ...
            <section class="rounded-2xl overflow-hidden relative group border border-border-subtle">
              ...
              <div class="absolute bottom-5 start-5">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-[10px] font-black text-brand tracking-widest">
                    Node_Status: Optimal
                  </span>
                </div>
              </div>
...
const sinks = [
  ...
  { icon: 'ph:phone-fill', iconClass: 'text-accent', value: '+1 (555) 902-1200' },
  { icon: 'ph:hard-drive-fill', iconClass: 'text-tx-muted', value: 'kinetic-prod-04' }
]
</script>
