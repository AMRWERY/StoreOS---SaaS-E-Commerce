  ...
  <div>
    <Teleport to="body">
      ...
      <Transition name="slide">
        <aside
          v-if="modelValue"
          class="fixed end-0 top-0 h-full w-full max-w-[420px] bg-[#080809] border-s border-white/5 shadow-2xl flex flex-col z-[101] overflow-y-auto hide-scrollbar"
        >
          <!-- Header -->
          ...
          <div class="flex-1 p-8 space-y-8">
            ...
            <!-- Node Status -->
            <section class="rounded-2xl overflow-hidden relative group border border-white/5">
              <img
...
const metrics = [
  {
    ...
    barClass: 'bg-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.5)]',
    barWidth: 'w-3/4',
    barStyle: {}
  },
  {
...
const sinks = [
  { icon: 'ph:at-bold', iconClass: 'text-indigo-500', value: 'admin@storeos.com' },
  { icon: 'ph:phone-fill', iconClass: 'text-orange-500', value: '+1 (555) 902-1200' },
  { icon: 'ph:hard-drive-fill', iconClass: 'text-gray-600', value: 'kinetic-prod-04' }
]
</script>
