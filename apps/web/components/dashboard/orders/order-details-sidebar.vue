<template>
  <div>
    <div class="fixed inset-0 z-50 overflow-hidden" @click.self="$emit('close')">
      <div class="absolute inset-0 bg-bg-overlay backdrop-blur-sm transition-opacity"></div>
      <aside
          ...
          <div class="mb-6">
            ...
            <div class="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p class="text-xs text-tx-secondary">{{ order.email || 'ethan.laurent@designstack.io' }}</p>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div v-for="i in 2" :key="i" class="flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  <h5 class="text-xs font-bold truncate text-tx-primary">Velocity Elite Runner</h5>
