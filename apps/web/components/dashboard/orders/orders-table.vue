  ...
  <div>
      ...
      <div class="col-span-3 flex items-center gap-4">
        ...
        >
          <Icon
            v-if="isAllSelected"
            name="ph:check-bold"
            class="text-[10px] text-tx-primary"
          />
        </div>
    ...
    <div class="space-y-4 mt-4">
      ...
      >
        <div class="col-span-3 flex items-center gap-4">
          <div
            @click.stop="$emit('toggle-selection', order.id)"
        ...
        <div class="col-span-2 flex flex-col items-center">
          ...
          <span class="text-[10px] text-tx-secondary font-black"
            >{{ order.itemsCount }} {{ t("dashboard.orders.items") }}</span
          >
        </div>
        ...
        <div class="col-span-2 flex items-center justify-end gap-2">
          ...
          <VButton
            variant="none"
            className="p-2 text-tx-secondary hover:text-tx-primary transition-colors"
            @click.stop=""
          >
