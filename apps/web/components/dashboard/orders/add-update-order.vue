        ...
        <div class="lg:col-span-2 space-y-8">
          ...
          <section class="bg-bg-primary border border-border-subtle rounded-2xl px-4 py-3.5">
            ...
            <div
              ...
              <Icon name="ph:caret-right-bold" class="text-tx-muted group-hover:text-tx-primary transition-colors" />
            </div>
          </section>
              ...
              <div v-else class="space-y-3">
                <div v-for="item in form.items" :key="item.id"
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[10px] text-tx-muted font-bold mt-0.5">{{ item.variant }}</p>
                  ...
                  <div class="flex items-center gap-3 shrink-0">
                    ...
                    <span class="text-sm font-bold text-brand min-w-[60px] text-end">${{ (item.price *
