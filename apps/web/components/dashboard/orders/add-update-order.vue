            ...
            <div
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-[10px] text-gray-600 font-medium mt-0.5">Create a new customer profile for this order.
                  </p>
                </div>
              </div>
            ...
            <div class="p-8">
              ...
              <div v-else class="space-y-3">
                <div v-for="item in form.items" :key="item.id"
                  ...
                  <img :src="item.image"
                    class="w-14 h-14 rounded-xl object-cover border border-white/5 grayscale opacity-70" />
                  ...
                  <div class="flex items-center gap-3 shrink-0">
                    <div class="flex items-center gap-1 bg-black border border-white/10 rounded-lg overflow-hidden">
                      <VButton variant="none"
                        className="px-2.5 py-1.5 text-gray-500 hover:text-white transition-colors text-xs"
                    ...
                    <span class="text-sm font-bold text-indigo-400 min-w-[60px] text-end">${{ (item.price *
