<template>
  <section
    ...
    <div>
      <h3 class="text-sm font-bold text-danger">{{ $t('dashboard.profile.dangerZone') }}</h3>
      <p class="text-xs text-danger/60 mt-1 font-medium">{{ $t('dashboard.profile.deleteDesc') }}
      </p>
    </div>
