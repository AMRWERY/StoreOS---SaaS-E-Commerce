            ...
            <div class="relative z-10 max-w-2xl w-full text-center flex flex-col items-center">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
                    ...
                    <VButton @click="handleGoHome" variant="none"
                        className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 text-white font-black text-[10px] tracking-[0.2em] rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all active:scale-95 flex items-center justify-center gap-3 group">
