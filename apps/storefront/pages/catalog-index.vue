            ...
            <div class="space-y-4">
              <div class="flex items-center gap-4">
                <div
                  ...
                  <Icon name="solar:folder-with-files-bold-duotone" class="w-7 h-7 text-brand" />
                </div>
                <h1 class="text-5xl lg:text-6xl font-bold tracking-tighter">Catalog Index</h1>
              </div>
              <p class="text-[15px] text-tx-secondary max-w-xl leading-relaxed tracking-tight font-medium">
      ...
      <div class="py-12 px-6 lg:px-12 max-w-[1400px] mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="cat in categories" :key="cat.id"
            ...
            <!-- Visual Node -->
            <div class="relative aspect-[16/9] overflow-hidden bg-black border-b border-border-subtle">
              <img :src="cat.img"
              ...
              <div class="absolute bottom-6 start-8">
                <h3 class="text-2xl font-bold tracking-tight text-white group-hover:text-brand transition-colors">
                  {{ cat.name }}
                </h3>
              </div>
            </div>
            ...
            <div class="p-8 space-y-6 flex-1 flex flex-col justify-between">
              <div class="space-y-4">
                <p class="text-[10px] font-black text-tx-muted tracking-widest">Active Sectors</p>
              ...
              <div class="pt-6 border-t border-border-subtle flex items-center justify-between">
                <div class="space-y-1">
                  <p class="text-[18px] font-bold text-tx-primary">{{ cat.count }}</p>
                  <p class="text-[9px] font-black text-tx-muted tracking-widest">Units Logged</p>
                </div>
                <button
