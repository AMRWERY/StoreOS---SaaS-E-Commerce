<template>
  <Teleport to="body">
    <div v-if="deletePageOpen" class="fixed inset-0 z-[200] flex items-center justify-center p-4" role="dialog"
      aria-modal="true">
      <div class="absolute inset-0 bg-black/65 backdrop-blur-sm" @click="deletePageOpen = false" />
      <div class="relative w-full max-w-md rounded-2xl border border-red-500/30 bg-bg-primary p-6 shadow-2xl">
        <div class="flex gap-3">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-tx-secondary">
              <strong class="text-tx-primary">{{ store.currentPage?.title }}</strong> and all its sections will be
