  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        @click="!isSaving && (publishOpen = false)"
      />
      ...
      >
        ...
        <template v-if="published">
          <div class="flex flex-col items-center text-center py-2">
            <div
              class="mb-4 flex size-14 items-center justify-center rounded-full bg-emerald-500/10 border border-emerald-500/20"
            >
        ...
        <template v-else>
          ...
          <p class="mt-2 text-sm leading-relaxed text-tx-secondary">
            Push the latest changes live. Visitors will see the updated theme
            and pages.
          </p>
          ...
          <ul
            ...
            class="mt-4 space-y-1.5 rounded-xl border border-border-subtle bg-bg-elevated p-3"
          >
            <li
            ...
            >
              ...
              <span
                class="rounded-full bg-emerald-500/10 px-2 py-0.5 text-[9px] font-black tracking-widest text-emerald-400"
              >
                WILL PUBLISH
              </span>
            </li>
