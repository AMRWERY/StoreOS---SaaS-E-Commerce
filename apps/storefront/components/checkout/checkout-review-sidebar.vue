<template>
  <aside class="w-full md:w-80 shrink-0 space-y-5">
    ...
    <section class="bg-bg-primary border border-border-subtle rounded-[16px] p-8">
      <h3 class="text-[11px] font-black mb-8 tracking-widest text-tx-secondary">{{ $t('storefront.checkout.orderSummary') }}</h3>
      ...
      <div class="flex items-baseline justify-between mb-8">
        <span class="text-[13px] font-bold text-tx-primary tracking-widest">{{ $t('storefront.checkout.total') }}</span>
      ...
      <div class="bg-black/30 border border-border-subtle rounded-[12px] p-4 flex items-center gap-4">
        ...
        <div>
          <p class="text-[9px] font-black text-tx-muted tracking-widest">{{ $t('storefront.checkout.paymentMethod') }}</p>
          <p class="text-[11px] font-bold text-tx-secondary">StoreOS Terminal Credit (•••• {{ lastFour }})</p>
        </div>
      </div>
    </section>
    ...
    <section class="bg-bg-primary border border-border-subtle rounded-[16px] p-8">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-[11px] font-black tracking-widest text-tx-secondary">{{ $t('storefront.checkout.shippingAddress') }}</h3>
      </div>
    ...
    <section class="bg-brand/5 border border-brand/10 rounded-[16px] p-8 space-y-5">
      <div class="flex items-center gap-3">
        ...
        <h3 class="text-[11px] font-black tracking-widest text-tx-secondary">{{ $t('storefront.checkout.needAssistance') }}</h3>
      </div>
