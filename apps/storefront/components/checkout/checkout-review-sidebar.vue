<template>
  <aside class="w-full md:w-80 shrink-0 space-y-5">
    ...
    >
      ...
      <div
        class="space-y-4 border-b border-border-subtle pb-8 mb-8 text-[13px] font-medium text-tx-secondary"
      >
      ...
      <!-- Payment Method -->
      <div
        class="bg-black/30 border border-border-subtle rounded-[12px] p-4 flex items-center gap-4"
      >
        <Icon
          name="ph:credit-card-fill"
          class="w-5 h-5 text-[#F97316] shrink-0"
        />
        <div>
    ...
    >
      ...
      <div
        class="space-y-1 text-[13px] font-medium text-tx-secondary leading-relaxed"
      >
    ...
    <!-- Support -->
    <section
      class="bg-brand/5 border border-brand/10 rounded-[16px] p-8 space-y-5"
    >
