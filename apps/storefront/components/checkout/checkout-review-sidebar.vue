<template>
  <aside class="w-full md:w-80 shrink-0 space-y-5">
    ...
    <section class="bg-[#0D0D18] border border-[#1C1C30] rounded-[16px] p-8">
      <h3 class="text-[11px] font-black mb-8 tracking-widest text-[#8888AA]">Order Summary</h3>
      ...
      <div class="bg-black/30 border border-[#1C1C30] rounded-[12px] p-4 flex items-center gap-4">
        ...
        <div>
          <p class="text-[9px] font-black text-[#50506A] tracking-widest">Payment Method</p>
    ...
    <section class="bg-[#0D0D18] border border-[#1C1C30] rounded-[16px] p-8">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h3 class="text-[11px] font-black tracking-widest text-[#8888AA]">Shipping Address</h3>
      </div>
    ...
    <section class="bg-[#6366F1]/5 border border-[#6366F1]/10 rounded-[16px] p-8 space-y-5">
      <div class="flex items-center gap-3">
        ...
        <h3 class="text-[11px] font-black tracking-widest text-[#8888AA]">Need Assistance?</h3>
      </div>
