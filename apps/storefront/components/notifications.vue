<template>
  <div>
    ...
    <button @click="isInternalOpen = true"
      :class="['relative text-tx-secondary hover:text-tx-primary p-2 transition-colors', isInternalOpen ? 'text-tx-primary' : '']">
              ...
              <div v-for="n in filteredNotifications" :key="n.id"
                ...
                <div class="flex gap-4">
                  ...
                  <div class="relative shrink-0">
                    <div
                      :class="['w-12 h-12 rounded-xl flex items-center justify-center border border-border-subtle shadow-inner', n.bgColor]">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs text-tx-secondary mt-1 line-clamp-2 leading-relaxed font-medium">{{ n.message }}</p>
