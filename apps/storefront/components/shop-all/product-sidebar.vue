  ...
  <aside class="w-full lg:w-[240px] shrink-0 space-y-12">
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            <Icon
              v-if="modelValue.category === cat"
              name="solar:check-read-bold"
              class="w-3 h-3 text-white"
            />
          </div>
          <span
            class="text-[12px] font-medium text-tx-secondary group-hover:text-tx-primary"
            :class="{ 'text-tx-primary': modelValue.category === cat }"
            >{{ cat }}</span
          >
          <input
            type="radio"
    ...
    <div class="space-y-6">
      ...
      <div class="relative h-1 w-full bg-border-subtle rounded-full">
        ...
        <div
          class="absolute -top-1.5 start-0 w-4 h-4 bg-white rounded-full border-2 border-brand cursor-pointer"
        ></div>
        <div
      ...
      <div class="grid grid-cols-2 gap-3">
        <div
          class="bg-bg-primary border border-border-subtle rounded-[8px] p-2 px-3"
        >
      ...
      <div class="flex flex-wrap gap-3">
        ...
        >
          <div
            ...
            @click="modelValue.selectedColor = color.name"
          ></div>
        </div>
      </div>
    </div>
