<template>
  <aside class="w-full lg:w-[240px] shrink-0 space-y-12">
    ...
    <!-- Category -->
    <div class="space-y-4">
      <h4 class="text-[11px] font-black tracking-[0.2em] text-[#8888AA]">Category</h4>
      <div class="space-y-3">
    ...
    <!-- Price Range -->
    <div class="space-y-6">
      <h4 class="text-[11px] font-black tracking-[0.2em] text-[#8888AA]">Price Range</h4>
    ...
    <!-- Colors -->
    <div class="space-y-4">
      <h4 class="text-[11px] font-black tracking-[0.2em] text-[#8888AA]">Colors</h4>
