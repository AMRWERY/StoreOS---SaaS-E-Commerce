<template>
  <div class="group/card relative h-full min-h-0">
    ...
    <VButton variant="none" type="button" title="Fast deploy to cart"
      className="absolute bottom-3 end-3 z-10 opacity-0 pointer-events-none group-hover/card:opacity-100 group-hover/card:pointer-events-auto bg-white text-black py-2 px-3 rounded-[8px] font-bold text-[10px] uppercase tracking-widest shadow-xl hover:bg-[#F0F0FF] active:scale-95 flex items-center gap-2 transition-opacity duration-200"
