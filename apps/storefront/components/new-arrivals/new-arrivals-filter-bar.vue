<template>
  <section
    class="sticky top-0 z-40 bg-bg-base/80 backdrop-blur-xl border-b border-border-subtle px-6 lg:px-12 py-4"
  >
    <div
      class="max-w-[1400px] mx-auto flex flex-wrap items-center justify-between gap-6"
    >
      ...
      <div class="flex items-center gap-6">
        ...
        >
          ...
          <span class="text-tx-primary">{{ t("storefront.shop.latest") }}</span>
